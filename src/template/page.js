...
const Page = ({ children, bgColour, home, title, homeBlockColour, pageBlockColour }) => {
  ...
  const titleBlock = home ? `h-50vh w-2/4 bg-${homeBlockColour}-400 text-6xl z-10 absolute top-0 mt-30vh`  : `h-20vh w-2/4 bg-${homeBlockColour}-500 text-6xl z-10 absolute top-0 mt-25vh`
  ...
  return (
    <div className={pageVar}>
      <div className="rounded-lg border-2 border-white">
        {home && <div className="m-0 m-auto h-90vh w-1/2 bg-duskyBlue-500 z-0 flex flex-wrap content-center"> 
